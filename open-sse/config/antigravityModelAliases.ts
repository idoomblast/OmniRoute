export const ANTIGRAVITY_PUBLIC_MODELS = Object.freeze([
  // Gemini 3.7 Flash tiers returned by the live model selector only for the IDE 2.8.1
  // client identity (older identities do not see them on :fetchAvailableModels).
  {
