/**
 * Qoder body encoding ported from 9router (decolua/9router, MIT) — itself
 * ported from qoder2api's QoderEncoding.java (via the CLIProxyAPIPlus
 ...
 * @param plaintext plaintext bytes to encode
